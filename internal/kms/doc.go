...
// operation as dek_ops_duration_seconds and dek_ops_total, and DEK rotations by
// reason; the metered keys above record their KMS wraps and unwraps against a
// provider as kek_ops_total and kek_ops_duration_seconds. This package owns the
...
// vault_ops_total and vault_ops_duration_seconds, labeled by namespace.
package kms
